# **Finance Fundamentals learned to build FinLedger**
**studied from the source Varsity by Zerodha**

## **Why should I invest?**

just do it man you already know it , one example of what if you invest - 

1. Investing in equities at an average rate of 15% per annum, the corpus would have grown to Rs.5.4Crs.
2. By investing in fixed income at an average rate of 9% per annum (good corporate bond), the corpus would have grown to Rs.3.3Crs.
...
**Gold, silver** and some metals like **Copper , silicon, uranium….**over the long term, have appreciated. Investments in these metals have yielded a CAGR return of approximately 5-8% over the last 20 years. There are several ways to invest in gold and silver. One can invest in jewelry, Exchange Traded Funds (ETF), or Sovereign Gold bonds, popularly called as SGBs.

### Asset Allocation -

It is wise to diversify your investment among the various asset classes. The technique of allocating money across asset classes is termed ‘Asset Allocation’ 
...
- A good investment practice is to build a portfolio that mixes all asset classes - for example :
    - a young professional may take a higher risk and allocate at least 60% of their investable amount in equity, 20% in precious metals, and 20% in fixed-income investments
...
we will study by taking one Example of a small textile business and see its growth through scenarios , here comes the Origin of Business 

**Origin of a Business**

will build a familiar story around this concept to understand IPOs better. Let us split this story into several scenes to understand how the business and the funding environment evolve and the circumstances that lead a company to list in the public market.

## Scene 1 – The Angels

- A passionate entrepreneur wants to start a business manufacturing **fashionable organic cotton t-shirts**.
- The main challenge for a new entrepreneur is **raising funds to start the business**.

### 1. Angel Investors

- When entrepreneurs cannot attract big investors initially, they usually approach **family and friends** for funding.
- People who invest money in the early stage of a startup are called **Angel Investors**.
- Angel funding is **not a loan**; it is **an investment in the business** in exchange for ownership.

### 2. Seed Fund

- The first capital used to start a business is called **Seed Fund**.
- It is sometimes called the **Friends & Family Round**.
- The money is deposited in the **company’s bank account**, not the entrepreneur’s personal account.

### 3. Example in the Story

- The entrepreneur and two friends raise **₹5 Crore** as seed funding.
- This becomes the **initial valuation of the company** since the only asset is cash.

### 4. Shares and Ownership

- Investors receive **share certificates**, giving them ownership in the company.
- If each share has a **Face Value (FV) of ₹10**:
    - ₹5 Crore capital = **50 lakh shares**.
- Face value is the **nominal value of a share**, usually between **₹1 to ₹10 or more** as per **SEBI guidelines**.

<aside>


Angel investors provide early-stage funding (seed capital) to startups in exchange for shares and ownership, helping entrepreneurs start and run their businesses.

</aside>

## Scene 2 - The VENTURE Capitalist (VC):

- After **2 years**, the business starts generating **steady revenue** and reaches **break-even**.
- The entrepreneur now plans to **expand the business** by:
    - Adding another **manufacturing unit**
    - Opening more **retail stores**.
- For expansion, the company needs **₹7 Crore** in new investment.

**1. Venture Capitalist (VC)**

- Investors who fund **growing startups with proven potential** are called **Venture Capitalists**.
- The funding provided at this stage is called **Series A funding**.

**2. Effects of VC Investment**

When VC money enters the business:

- **Share dilution** occurs (promoter’s ownership percentage decreases).
- **Company valuation increases**.
- **Early investors (Angel investors)** gain **notional profits** because the company is now worth more.

**3. Business Growth**

- With the new funds:
    - The company builds **another manufacturing unit**.
    - Opens **more retail stores**.
- The product becomes **more popular**, leading to:
    - **Higher revenues**
...
**Venture Capitalists invest in startups that have started generating revenue and show growth potential. Their investment (Series A funding) helps businesses expand, increases company valuation, and creates wealth for early investors.**

</aside>

## Scene 3 - THE BANKERS

- After **3 more years**, the company becomes **very successful** and plans to expand into **three more cities**.
- To support expansion, it needs to:
    - Increase **production capacity**
    - **Hire more employees**

### 1. CAPEX (Capital Expenditure)

- Large spending done by a company to **expand or improve business operations** is called **Capital Expenditure (CAPEX)**.
- The company estimates **₹40 Crore** for CAPEX.

### 2. Ways to Raise Funds for CAPEX

The company can raise money through:

1. **Internal Accruals**
    - Using **profits earned by the company**.
    - In this case: **₹15 Crore**.
2. **Series B Funding (VC Investment)**
    - Raising money by **selling shares to another Venture Capitalist**.
    - In this case: **₹10 Crore**.
3. **Debt (Bank Loan)**
    - Borrowing money from a **bank**.
    - In this case: **₹15 Crore**.

### 3. Effects of Series B Funding

- **Company valuation increases again**.
- **Early investors gain higher notional profits** because the company’s value has grown.

### 4. Wealth Creation

- Successful businesses can create **huge wealth for founders and investors**.
- Examples of companies that created massive wealth:
    - Infosys
    - HDFC Bank
    - Google
    - Apple
...
To fund expansion (CAPEX), companies can use **internal profits, venture capital funding (Series B), or bank loans (debt)**. As the company grows, its **valuation increases**, creating wealth for early investors and founders.

</aside>

## Scene 4 - Private Equity

- After **8 years**, the company becomes very successful and plans to **expand across the country**.
- It also **diversifies products** by selling:
    - Fashion accessories
    - Designer cosmetics
    - Perfumes
- The new **CAPEX requirement is ₹60 Crore**.

### 1. Why Not Debt?

- The company avoids **bank loans (debt)** because **interest payments (finance charges)** reduce profits.
- Example: If profit = ₹100 and interest = ₹20 → actual profit = **₹80**.

### 2. Series C Funding

- The company decides to raise money through **Series C funding**.
- Instead of Venture Capitalists, they approach **Private Equity (PE) investors**.

### 3. Private Equity (PE)

- PE investors provide **large investments to mature companies** for expansion.
- They usually invest when the company already has:
    - **Stable revenue**
    - **Several years of operations**

### 4. Difference Between VC and PE

- **Investment Size:**
    - VC → smaller investments
    - PE → large investments
- **Business Stage:**
    - VC → early-stage startups
    - PE → mature companies
- **Risk Level:**
    - VC → higher risk
    - PE → lower risk
- **Control:**
    - PE investors often **take a board seat** and monitor company operations.

### 5. Role of PE Investment

- Helps companies fund **large CAPEX projects**.
- Supports **large-scale expansion and diversification**.

<aside>
📌

Private Equity investors provide **large funding to well-established companies** for major expansion projects. They invest at a later stage than VCs and often participate in **company management through board positions**.

</aside>

## **Scene 5 – The IPO**

**5 years after Private Equity investment**, the company becomes very successful:

- Present in **major cities across the country**
- **Stable revenue and profits**
- Investors are satisfied.

### 1. New Goal – Global Expansion

- The promoter now wants to **expand internationally**.
- Plans to open **at least two stores in major cities worldwide**.
- Requires large investments in:
    - **Market research**
    - **Hiring skilled people**
    - **Increasing manufacturing capacity**
    - **Global real estate**
- Total **CAPEX requirement = ₹200 Crore**.

### 2. Funding Options

The company can raise funds through:

1. **Internal accruals** (using company profits)
2. **Series D funding** from another Private Equity investor
3. **Bank loans (debt)**
4. **Bonds** (another way of raising debt)
5. **Initial Public Offering (IPO)**
6. **Combination of these methods**

### 3. Initial Public Offering (IPO)

- The company decides to fund expansion through **internal profits + IPO**.
- In an **IPO**, the company **offers its shares to the public for the first time**.
- The public can **buy shares by paying a set price**, becoming shareholders.

### 4. Importance of IPO

An IPO raises several important questions:

- Why do companies **go public**?
- Why didn’t the company launch an IPO earlier?
- What happens to **existing investors after IPO**?
- What do **public investors look for before investing**?
...
When companies reach a large scale and need significant capital for expansion, they may raise funds through an **IPO**, allowing the **general public to buy shares** and become part owners of the company.
...
### **(Angel → VC → Series B → PE → IPO)**

### 1. **Idea Stage – Angel Investors**

- Entrepreneur starts with a **business idea**.
- Initial funding comes from **Angel Investors** (friends, family, or professional angels).
- This money is called **Seed Funding**.
- Investors receive **shares in the company** in return.
- Purpose: **Start operations** (manufacturing, hiring, first store, etc.).

---

### 2. **Early Growth – Venture Capital (Series A)**

- Business starts generating **revenue and reaches break-even**.
- Company wants to **expand operations**.
- **Venture Capitalists (VCs)** invest money in exchange for equity.
- This funding round is called **Series A**.
- Effects:
    - **Company valuation increases**
    - **Share dilution** occurs
    - **Early investors gain notional profit**

---

### 3. **Expansion Stage – Series B**

- Company becomes more successful and plans **bigger expansion**.
- Requires funds for **CAPEX (Capital Expenditure)** such as:
    - More factories
    - More stores
    - More employees.
- Funds are raised through:
    ...
    - **Series B VC funding**
    - **Bank loans (Debt)**.
- Company valuation **increases further**, benefiting earlier investors.

---

### 4. **Mature Growth – Private Equity (Series C)**

- Company is now **well-established with strong revenue**.
- Plans **large-scale expansion and diversification**.
- Requires **large capital investment**.
- **Private Equity (PE) investors** step in.
- Differences from VC:
    - **Larger investment amounts**
    - Invest in **mature companies**
    - Often **take board seats** to monitor operations.

---

### 5. **Large Expansion – Initial Public Offering (IPO)**

- Company plans **global expansion** and needs huge capital.
- Decides to **go public** through an **IPO**.
- Shares are offered to the **general public for the first time**.
- Public investors buy shares and become **company shareholders**.
- After IPO:
    - Company becomes **publicly listed**
    - Early investors may **sell shares and realize profits**
    - Company gets **large capital for expansion**.
</aside>
...
so the main reason that states why Companies Go public are :
...
4. Reward Employees - Employees, working for the company would have shares allotted to them as an incentive. This arrangement between the employee and the company is called the “Employee Stock Option” or ESOPS. The shares are allotted at a discount to the employees.
5. improve visibility - Going public increases visibility as the company is publicly held and traded. There is a greater chance of people’s interest in the company, consequently impacting its growth.

### How Merchant bankers help a company to go public  :

Merchant bankers are called **Book Running Lead Managers (BRLM)/Lead Managers (LM).** The job of a merchant banker is to assist the company with various aspects of the IPO process, including:
...
### Lets go with the sequence of how IPO are listed -
